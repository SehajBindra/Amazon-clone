  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="flex items-center bg-amazon_light_blue text-white space-x-3 pl-6 p-2">
        ...
        <p className="link text-xs font-semibold md:text-base">All</p>
        <p className="link text-xs font-semibold md:text-base"> Prime Video</p>
        <p className="link text-xs font-semibold md:text-base">
          {" "}
          Amazon Business
        </p>
        <p className="link text-xs font-semibold md:text-base">
