  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="flex items-center bg-amazon_light_blue text-white space-x-3 pl-6 p-2">
        ...
        <p className="link tex-xs md:text-base">All</p>
        <p className="link tex-xs md:text-base"> Prime Video</p>
        <p className="link tex-xs md:text-base"> Amazon Business</p>
        <p className="link tex-xs md:text-base"> Today's Deals</p>
        <p className="hidden link md:inline lg:inline tex-xs md:text-base">
          Electronics
        </p>
        <p className="link  hidden md:inline  lg:inline tex-xs md:text-base">
          Food & Grocery
        </p>
        <p className="link hidden  lg:inline tex-xs md:text-base">
          Health & Personal care
        </p>
        <p className="link  hidden lg:inline tex-xs md:text-base">Buy Again</p>
        <p className="link  hidden lg:inline tex-xs md:text-base">
          Shopper toolkit
        </p>
      </div>
