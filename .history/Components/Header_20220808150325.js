  ...
  return (
    <header>
      ...
      <div className="flex items-center bg-amazon_light_blue text-white space-x-3 pl-6 p-2">
        ...
        <p className="link md:inline">Food & Grocery</p>
        <p className="link md:inline">Health & Personal care</p>
        <p className="link md:inline">Buy Again</p>
        <p className="link md:inline">Shopper toolkit</p>
      </div>
    </header>
  );
}
